...
namespace QQbarProcessor
{
        ...
        public:
                ...
                float _mc_major_thrust_value;
                float _mc_minor_thrust_value;
                float _mc_principle_thrust_value;
                float _mc_major_thrust_axis[3];
                float _mc_minor_thrust_axis[3];
                float _mc_principle_thrust_axis[3];
                ...
                void Clear()
                {
                        ...
                        _mc_stable_d12 = 0;
                        _mc_stable_d23 = 0;
                        _mc_major_thrust_value = 0;
                        _mc_minor_thrust_value = 0;
                        _mc_principle_thrust_value = 0;
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                                _mc_major_thrust_axis[i] = 0;
                                _mc_minor_thrust_axis[i] = 0;
                                _mc_principle_thrust_axis[i] = 0;
                        }
