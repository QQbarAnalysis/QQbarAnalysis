...
void f1f2() {
  ...
  cout<<"Results"<<endl;
  cout<<h_f_bb[1]->Integral()<<" "<<h_f_cc[1]->Integral()<<" "<<h_f_qq[1]->Integral()<<" "<<h_bkg[1]->Integral()<<" "<<endl;
  cout<<h_f_bb[2]->Integral()<<" "<<h_f_cc[2]->Integral()<<" "<<h_f_qq[2]->Integral()<<" "<<h_bkg[2]->Integral()<<" "<<endl;
  cout<<" "<<endl;
  cout<< "BKg contribution to f1="<<100.*h_bkg[1]->Integral(0,15)/(h_f_bb[1]->Integral(0,15)+h_f_cc[1]->Integral(0,15)+h_f_qq[1]->Integral(0,15))<<" %"<<endl;
  cout<< " +1% unc ="<<100.*(h_bkg[1]->Integral(0,15)+h_bkg[1]->Integral(0,15)*0.01)/(h_f_bb[1]->Integral(0,15)+h_f_cc[1]->Integral(0,15)+h_f_qq[1]->Integral(0,15))<<" %"<<endl;
  cout<< " -1% unc ="<<100.*(h_bkg[1]->Integral(0,15)-h_bkg[1]->Integral(0,15)*0.01)/(h_f_bb[1]->Integral(0,15)+h_f_cc[1]->Integral(0,15)+h_f_qq[1]->Integral(0,15))<<" %"<<endl;
  cout<<" "<<endl;
  cout<< "BKg contribution to f2="<<100.*h_bkg[2]->Integral(0,15)/(h_f_bb[2]->Integral(0,15)+h_f_cc[2]->Integral(0,15)+h_f_qq[2]->Integral(0,15))<<" %"<<endl;
  cout<< " +1% unc ="<<100.*(h_bkg[2]->Integral(0,15)+h_bkg[2]->Integral(0,15)*0.01)/(h_f_bb[2]->Integral(0,15)+h_f_cc[2]->Integral(0,15)+h_f_qq[2]->Integral(0,15))<<" %"<<endl;
  cout<< " -1% unc ="<<100.*(h_bkg[2]->Integral(0,15)-h_bkg[2]->Integral(0,15)*0.01)/(h_f_bb[2]->Integral(0,15)+h_f_cc[2]->Integral(0,15)+h_f_qq[2]->Integral(0,15))<<" %"<<endl;
