...
void draw_sig_bkg_btag() {
  ...
  TFile *f = new TFile("../output_20200427/selection_cuts0_bbbar_genkt_restorer_Kgamma35_250GeV_"+pol+".root");
  TH1F *h_parton = (TH1F*)f->Get("h_costheta_bb");
  TH1F *h_parton_qq = (TH1F*)f->Get("h_costheta_qq");
  TH1F *h_parton_cc = (TH1F*)f->Get("h_costheta_cc");
  h_parton->Add(h_parton_qq);
  h_parton->Add(h_parton_cc);
  
  f = new TFile("../output_20200427/selection_"+cuts+"_bbbar_genkt_restorer_Kgamma35_250GeV_"+pol+".root");
  TH1F *h_reco = (TH1F*)f->Get("h_costheta_bb");
  TH1F *h_bkg_qq = (TH1F*)f->Get("h_costheta_qq");
  TH1F *h_bkg_cc = (TH1F*)f->Get("h_costheta_cc");
  h_reco->Add(h_bkg_qq);
  h_reco->Add(h_bkg_cc);

  f = new TFile("../output_20200427/selection_"+cuts+"_bbbar_radret_genkt_R125_Kgamma35_250GeV_"+pol+".root");
  //"../output_20200427/selection_cuts%i_bbbar_radret_genkt_R125_Kgamma35_"+cuts+"_250GeV_"+pol+".root");
  TH1F *h_bkg_radreturn = (TH1F*)f->Get("h_costheta_radreturn");

  f = new TFile("../output_20200427/selection_"+cuts+"_bkg_genkt_restorer_Kgamma35_ZZ_250GeV_"+pol+".root");
  //"../output_20200427/bkg_Kgamma35_ZZ_genkt_restorer_"+cuts+"_250GeV_"+pol+".root");
  TH1F *h_bkg_zz = (TH1F*)f->Get("h_costheta_bb");

  f = new TFile("../output_20200427/selection_"+cuts+"_bkg_genkt_restorer_Kgamma35_WW_250GeV_"+pol+".root");
  //"../output_20200427/bkg_Kgamma35_WW_genkt_restorer_"+cuts+"_250GeV_"+pol+".root");
  TH1F *h_bkg_ww = (TH1F*)f->Get("h_costheta_bb");

  f = new TFile("../output_20200427/selection_"+cuts+"_bkg_genkt_restorer_Kgamma35_HZ_250GeV_"+pol+".root");
  //"../output_20200427/bkg_Kgamma35_HZ_genkt_restorer_"+cuts+"_250GeV_"+pol+".root");
  TH1F *h_bkg_hz = (TH1F*)f->Get("h_costheta_bb");
  ...
  hreco->GetXaxis()->SetRangeUser(0,1);
  hreco->Draw("histo");
  ...
  leg2->AddEntry(h_bkg_other,TString::Format("Others: %0.2f",(hz+ww+zz)*100)+"%","f");
  leg->SetFillColor(0);
  leg->SetLineColor(0);
