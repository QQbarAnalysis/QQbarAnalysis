  // Declaration of leaf types
   ...
   Int_t           pfo_truejet_pdg[182];   //[pfo_n]
   Int_t           pfo_truejet_type[182];   //[pfo_n]
   ...
   Float_t         pfo_piddedx_e_dedxdist[182];   //[pfo_n]
   Float_t         pfo_piddedx_mu_dedxdist[182];   //[pfo_n]
   Float_t         pfo_piddedx_pi_dedxdist[182];   //[pfo_n]
   Float_t         pfo_piddedx_k_dedxdist[182];   //[pfo_n]
   Float_t         pfo_piddedx_p_dedxdist[182];   //[pfo_n]
   Float_t         pfo_piddedx_e_lkhood[182];   //[pfo_n]
   Float_t         pfo_piddedx_mu_lkhood[182];   //[pfo_n]
   Float_t         pfo_piddedx_pi_lkhood[182];   //[pfo_n]
   Float_t         pfo_piddedx_k_lkhood[182];   //[pfo_n]
   Float_t         pfo_piddedx_p_lkhood[182];   //[pfo_n]
