...
Int_t           pfo_truejet_pdg[999];   //[pfo_n]
Int_t           pfo_truejet_type[999];   //[pfo_n]
...
Float_t         pfo_pid_eprob[999];   //[pfo_n]
Float_t         pfo_pid_muprob[999];   //[pfo_n]
Float_t         pfo_pid_piprob[999];   //[pfo_n]
Float_t         pfo_pid_kprob[999];   //[pfo_n]
Float_t         pfo_pid_pprob[999];   //[pfo_n]
Float_t         pfo_pid_hprob[999];   //[pfo_n]
Int_t           pfo_piddedx[999];   //[pfo_n]
Float_t         pfo_piddedx_likelihood[999];   //[pfo_n]
Float_t         pfo_piddedx_eprob[999];   //[pfo_n]
Float_t         pfo_piddedx_muprob[999];   //[pfo_n]
Float_t         pfo_piddedx_piprob[999];   //[pfo_n]
Float_t         pfo_piddedx_kprob[999];   //[pfo_n]
Float_t         pfo_piddedx_pprob[999];   //[pfo_n]
Float_t         pfo_piddedx_hprob[999];   //[pfo_n]
Float_t         pfo_piddedx_e_dedxdist[999];   //[pfo_n]
Float_t         pfo_piddedx_mu_dedxdist[999];   //[pfo_n]
Float_t         pfo_piddedx_pi_dedxdist[999];   //[pfo_n]
Float_t         pfo_piddedx_k_dedxdist[999];   //[pfo_n]
Float_t         pfo_piddedx_p_dedxdist[999];   //[pfo_n]
Float_t         pfo_piddedx_e_lkhood[999];   //[pfo_n]
Float_t         pfo_piddedx_mu_lkhood[999];   //[pfo_n]
Float_t         pfo_piddedx_pi_lkhood[999];   //[pfo_n]
Float_t         pfo_piddedx_k_lkhood[999];   //[pfo_n]
Float_t         pfo_piddedx_p_lkhood[999];   //[pfo_n]
Float_t         pfo_pidtof_closest_beta_0ps[999];   //[pfo_n]
Float_t         pfo_pidtof_closest_beta_10ps[999];   //[pfo_n]
Float_t         pfo_pidtof_closest_beta_50ps[999];   //[pfo_n]
Float_t         pfo_pidtof_closest_beta_100ps[999];   //[pfo_n]
Float_t         pfo_pidtof_fastest_beta_0ps[999];   //[pfo_n]
Float_t         pfo_pidtof_fastest_beta_10ps[999];   //[pfo_n]
Float_t         pfo_pidtof_fastest_beta_50ps[999];   //[pfo_n]
Float_t         pfo_pidtof_fastest_beta_100ps[999];   //[pfo_n]
Float_t         pfo_pidtof_cylfit_beta_0ps[999];   //[pfo_n]
Float_t         pfo_pidtof_cylfit_beta_10ps[999];   //[pfo_n]
Float_t         pfo_pidtof_cylfit_beta_50ps[999];   //[pfo_n]
Float_t         pfo_pidtof_cylfit_beta_100ps[999];   //[pfo_n]
Float_t         pfo_pidtof_closestfit_beta_0ps[999];   //[pfo_n]
Float_t         pfo_pidtof_closestfit_beta_10ps[999];   //[pfo_n]
Float_t         pfo_pidtof_closestfit_beta_50ps[999];   //[pfo_n]
Float_t         pfo_pidtof_closestfit_beta_100ps[999];   //[pfo_n]
Float_t         pfo_pidtof_p_at_calo[999];   //[pfo_n]
