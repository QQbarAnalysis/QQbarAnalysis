...
void purity_models() {
  ...
  TFile *f = new TFile(folder+"bbbar_l5_valencia1.4_cuts4_500GeV_eL_btag1_0.9_btag2_0.2_nbins20.root");
  ...
  y[2]=a/b;
  a = h_p_value_BcKc_l5->GetBinError(5)*h_reco_BcKc_l5->GetEntries() + h_p_value_KcBc_l5->GetBinError(5)*h_reco_KcBc_l5->GetEntries();
  ey[2] = a/b;
  ...
  y[3]=a/b;
  a = h_p_value_BcKc_same1_l5->GetBinError(5)*h_reco_BcKc_same1_l5->GetEntries() + h_p_value_BcKc_same2_l5->GetBinError(5)*h_reco_BcKc_same2_l5->GetEntries();
  ey[3] = a/b;
  ...
  // s5
  //folder="../assym/";
  TFile *f2 = new TFile(folder+"bbbar_s5_valencia1.4_cuts4_500GeV_eL_btag1_0.9_btag2_0.2_nbins20.root");
  ...
  y[2]=a/b;
  a = h_p_value_BcKc_s5->GetBinError(5)*h_reco_BcKc_s5->GetEntries() + h_p_value_KcBc_s5->GetBinError(5)*h_reco_KcBc_s5->GetEntries();
  ey[2] = a/b;
  ...
  y[3]=a/b;
  a = h_p_value_BcKc_same1_s5->GetBinError(5)*h_reco_BcKc_same1_s5->GetEntries() + h_p_value_BcKc_same2_s5->GetBinError(5)*h_reco_BcKc_same2_s5->GetEntries();
  ey[3] = a/b;
  ...
  TFile *f3 = new TFile("/home/irles/ownCloudCNRS/HeavyFlavours/macros/assym_tracks/bbbar_genkt_restorer_cuts6_250GeV_eL_btag1_0.9_btag2_0.2_nbins40.root");
