...
void observable::SaveRootFile(std::vector<TH1F*> asymm_all, std::vector<TH2F*> resolution, TString polarization="eL"){
  ...
  TFile *MyFile = new TFile(TString::Format("%s_500GeV_%s_btag1_%0.1f_btag2_%0.1f_nbins%i.root",process.Data(),polarization.Data(),btag1,btag2,nbins),"RECREATE");
  MyFile->cd();
  //partonlevel
...
void observable::Selection(int n_entries=-1, int selection_type=0, TString polarization="eL")
{
  ...
  TFile *MyFile = new TFile(TString::Format("selection_%s_500GeV_%s_btag1_%0.1f_btag2_%0.1f.root",process.Data(),polarization.Data(),btag1,btag2),"RECREATE");
  MyFile->cd();
  ...
  cout<<TString::Format("selection_%s_500GeV_%s_btag1_%0.1f_btag2_%0.1f.root",process.Data(),polarization.Data(),btag1,btag2)<<endl;
...
void observable::AngularDistributions(int n_entries=-1,  TString polarization="eL")
{
  ...
  TFile *MyFile = new TFile(TString::Format("angular_%s_btag1_%0.1f_btag2_%0.1f.root",process.Data(),btag1,btag2),"RECREATE");
  MyFile->cd();
  ...
  // TH1F * h_cos_kaon_088_0 = new TH1F("h_cos_kaon_088_0","h_cos_kaon_088_0",160,-1,1);
  // TH2F * h_cos_kaon_088_jet_0 = new TH2F("h_cos_kaon_088_jet_0","h_cos_kaon_088_jet_0",160,-1,1,40,-0.2,0.2);
  // TH1F * h_cos_kaon_088_2 = new TH1F("h_cos_kaon_088_2","h_cos_kaon_088_2",160,-1,1);
  // TH2F * h_cos_kaon_088_jet_2 = new TH2F("h_cos_kaon_088_jet_2","h_cos_kaon_088_jet_2",160,-1,1,40,-0.2,0.2);
  // TH1F * h_cos_kaon_088_4 = new TH1F("h_cos_kaon_088_4","h_cos_kaon_088_4",160,-1,1);
  // TH2F * h_cos_kaon_088_jet_4 = new TH2F("h_cos_kaon_088_jet_4","h_cos_kaon_088_jet_4",160,-1,1,40,-0.2,0.2);

  // TH1F * h_cos_kaon_0 = new TH1F("h_cos_kaon_0","h_cos_kaon_0",160,-1,1);
  // TH2F * h_cos_kaon_jet_0 = new TH2F("h_cos_kaon_jet_0","h_cos_kaon_jet_0",160,-1,1,40,-0.2,0.2);
  // TH1F * h_cos_kaon_2 = new TH1F("h_cos_kaon_2","h_cos_kaon_2",160,-1,1);
  // TH2F * h_cos_kaon_jet_2 = new TH2F("h_cos_kaon_jet_2","h_cos_kaon_jet_2",160,-1,1,40,-0.2,0.2);
  // TH1F * h_cos_kaon_4 = new TH1F("h_cos_kaon_4","h_cos_kaon_4",160,-1,1);
  // TH2F * h_cos_kaon_jet_4 = new TH2F("h_cos_kaon_jet_4","h_cos_kaon_jet_4",160,-1,1,40,-0.2,0.2);

  // TH2F * h_cos_tpchits_0 = new TH2F("h_cos_tpchits_0","h_cos_tpchits_0",160,-1,1,501,-0.5,500.5);
  // TH2F * h_cos_tpchits_2 = new TH2F("h_cos_tpchits_2","h_cos_tpchits_2",160,-1,1,501,-0.5,500.5);
  // TH2F * h_cos_tpchits_4 = new TH2F("h_cos_tpchits_4","h_cos_tpchits_4",160,-1,1,501,-0.5,500.5);
  ...
  // TH1F * h_btag_cos_kaon_088_0 = new TH1F("h_btag_cos_kaon_088_0","h_btag_cos_kaon_088_0",160,-1,1);
  // TH2F * h_btag_cos_kaon_088_jet_0 = new TH2F("h_btag_cos_kaon_088_jet_0","h_btag_cos_kaon_088_jet_0",160,-1,1,40,-0.2,0.2);
  // TH1F * h_btag_cos_kaon_088_2 = new TH1F("h_btag_cos_kaon_088_2","h_btag_cos_kaon_088_2",160,-1,1);
  // TH2F * h_btag_cos_kaon_088_jet_2 = new TH2F("h_btag_cos_kaon_088_jet_2","h_btag_cos_kaon_088_jet_2",160,-1,1,40,-0.2,0.2);
  // TH1F * h_btag_cos_kaon_088_4 = new TH1F("h_btag_cos_kaon_088_4","h_btag_cos_kaon_088_4",160,-1,1);
  // TH2F * h_btag_cos_kaon_088_jet_4 = new TH2F("h_btag_cos_kaon_088_jet_4","h_btag_cos_kaon_088_jet_4",160,-1,1,40,-0.2,0.2);

  // TH1F * h_btag_cos_kaon_0 = new TH1F("h_btag_cos_kaon_0","h_btag_cos_kaon_0",160,-1,1);
  // TH2F * h_btag_cos_kaon_jet_0 = new TH2F("h_btag_cos_kaon_jet_0","h_btag_cos_kaon_jet_0",160,-1,1,40,-0.2,0.2);
  // TH1F * h_btag_cos_kaon_2 = new TH1F("h_btag_cos_kaon_2","h_btag_cos_kaon_2",160,-1,1);
  // TH2F * h_btag_cos_kaon_jet_2 = new TH2F("h_btag_cos_kaon_jet_2","h_btag_cos_kaon_jet_2",160,-1,1,40,-0.2,0.2);
  // TH1F * h_btag_cos_kaon_4 = new TH1F("h_btag_cos_kaon_4","h_btag_cos_kaon_4",160,-1,1);
  // TH2F * h_btag_cos_kaon_jet_4 = new TH2F("h_btag_cos_kaon_jet_4","h_btag_cos_kaon_jet_4",160,-1,1,40,-0.2,0.2);

  // TH2F * h_btag_cos_tpchits_0 = new TH2F("h_btag_cos_tpchits_0","h_btag_cos_tpchits_0",160,-1,1,501,-0.5,500.5);
  // TH2F * h_btag_cos_tpchits_2 = new TH2F("h_btag_cos_tpchits_2","h_btag_cos_tpchits_2",160,-1,1,501,-0.5,500.5);
  // TH2F * h_btag_cos_tpchits_4 = new TH2F("h_btag_cos_tpchits_4","h_btag_cos_tpchits_4",160,-1,1,501,-0.5,500.5);
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	for(int ivtx=0; ivtx<jet_nvtx[ijet]; ivtx++) {
	  for(int itrack=0; itrack<jet_vtx_ntrack[ijet][ivtx]; itrack++) {
	    ...
	    //int tpchits =jet_track_tpchits[ijet][ivtx][itrack];
	    std::vector<float> p;
  ...
  h_cos_track_jet_4->Write();
   ...
   // h_cos_kaon_088_0->Write();
   // h_cos_kaon_088_jet_0->Write();
   // h_cos_kaon_088_2->Write();
   // h_cos_kaon_088_jet_2->Write();
   // h_cos_kaon_088_4->Write();
   // h_cos_kaon_088_jet_4->Write();

   //  h_cos_kaon_0->Write();
   // h_cos_kaon_jet_0->Write();
   // h_cos_kaon_2->Write();
   // h_cos_kaon_jet_2->Write();
   // h_cos_kaon_4->Write();
   // h_cos_kaon_jet_4->Write();

   // h_cos_tpchits_0->Write();
   // h_cos_tpchits_2->Write();
   // h_cos_tpchits_4->Write();
  ...
  h_btag_cos_track_jet_4->Write();
   ...
   // h_btag_cos_kaon_088_0->Write();
   // h_btag_cos_kaon_088_jet_0->Write();
   // h_btag_cos_kaon_088_2->Write();
   // h_btag_cos_kaon_088_jet_2->Write();
   // h_btag_cos_kaon_088_4->Write();
   // h_btag_cos_kaon_088_jet_4->Write();

   //  h_btag_cos_kaon_0->Write();
   // h_btag_cos_kaon_jet_0->Write();
   // h_btag_cos_kaon_2->Write();
   // h_btag_cos_kaon_jet_2->Write();
   // h_btag_cos_kaon_4->Write();
   // h_btag_cos_kaon_jet_4->Write();

   // h_btag_cos_tpchits_0->Write();
   // h_btag_cos_tpchits_2->Write();
   // h_btag_cos_tpchits_4->Write();
...
std::vector<float> observable::CalculateP(TH1F* h_accepted, TH1F *h_rejected)
{
  ...
  for(int j1=-1;j1<2; j1++) {
	...
	if(p >0 || p2>0 ) p=max(p,p2);
	//      cout<<p<<endl;
	if(p>0 && p<1) { perror+=pow(pmean-p,2); nstd++;}
	//	if(p>pvaluemax && p>0 && p<1) pvaluemax=p;
      }
    }
    }
  perror = sqrt(perror)/sqrt((nstd*(nstd-1)));
  */
  cout<<pmean<<" "<<perror<<endl;
  std::vector<float> resultaverage;
  for(int i=0; i<nbins/2; i++) resultaverage.push_back(pmean);
  for(int i=0; i<nbins/2; i++) resultaverage.push_back(perror);
...
TH1F* observable::CorrectHistoDoubleTag(TH1F* histo, std::vector<float> p_vect) {
  ...
  for(int i=1; i<nbins/2+1; i++) {
    ...
    //corrected->SetBinError(i, sqrt( pow(error_i,2) + pow( (corrected_up->GetBinContent(i)- corrected_down->GetBinContent(i))/2.,2)));
    corrected->SetBinError(nbins+1-i,error_41i );
    //corrected->SetBinError(nbins+1-i, sqrt( pow(error_41i,2) + pow( (corrected_up->GetBinContent(nbins+1-i)- corrected_down->GetBinContent(nbins+1-i))/2.,2)));
  }
...
TH1F* observable::MakeCorrection(TString type, TH1F* h_reco, TH1F* h_rejected) {
  ...
  for(unsigned i=0; i<p_b_vect.size()/2; i++) {
    if(p_b_vect.at(i+nbins/2)>0 && p_b_vect.at(i+nbins/2)<1 && p_b_vect.at(i)>0 && p_b_vect.at(i)<1) {
      p_b->SetBinContent(nbins/2-i,p_b_vect.at(i));
      p_b->SetBinError(nbins/2-i,p_b_vect.at(i+nbins/2));
    } else {
      p_b->SetBinContent(nbins/2-i,0);
      p_b->SetBinError(nbins/2-i,0);
      p_b_vect.at(i+nbins/2)=1.0;
      p_b_vect.at(i)=1.0;
    }
  }
...
bool observable::PreSelectionTest(int type=0) {
  ...
  if(type ==5 )  if(  jet_btag[0]>btag1 && jet_btag[1]>btag2 && y12>0.1 && sphericity<0.03 && bbmass>200 && (b1mass+b2mass) >40 ) return true;*/
